...
const Banner = () => {
    ...
    return (
        <div className="container">
            ...
            <section style={{ backgroundImage: `url(${banner4})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundBlendMode: 'overlay', backgroundColor: 'rgba(0, 0, 0, 0.3)', minHeight: '600px' }}>
