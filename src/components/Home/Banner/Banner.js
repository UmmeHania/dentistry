...
const Banner = () => {
    ...
    return (
        <div className="">
            ...
            <section style={{ backgroundImage: `url(${bannerfinal})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundBlendMode: 'overlay', backgroundColor: 'rgba(0, 0, 0, 0.3)', minHeight: '600px' }}>
